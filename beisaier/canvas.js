...
(function(){
    ...
    //初始化位置
    function init(){
        aBtn[0].style.left=point[0].x+'px';
        aBtn[0].style.top=point[0].y+'px';
        aBtn[1].style.left=point[1].x+'px';
        aBtn[1].style.top=point[1].y+'px';
        aBtn[2].style.left=point[2].x+'px';
    ...
    function drawBSE(cxt){
        ...
        cxt.quadraticCurveTo(point[2].x,point[2].y,point[1].x,point[1].y );
        cxt.stroke();
        cxt.restore();
    }
    //显示代码
